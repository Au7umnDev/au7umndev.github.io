                                ...
                                <Flex direction='column'>
                                    <Flex gap={2} direction='column'>
                                        <Flex direction='column' alignItems='center'>
                                            {showImage && (
                                            <Image src={'https://github.com/Au7umnDev/au7umndev.github.io/blob/main/src/img/no_camera.jpg?raw=true'} alt="Waiting for camera..." style={{ position: 'absolute', width: '640px', height: '480px', zIndex: 99995 }}/>
                                            )}
