...
const ringsRepository = [
    {
        ...
        imageSrc: [
            '${process.env.PUBLIC_URL}/src/img/Ring_black_and_red_1.jpg',
            '${process.env.PUBLIC_URL}/src/img/Ring_black_and_red_2.jpg',
            '${process.env.PUBLIC_URL}/src/img/Ring_black_and_red_3.jpg'
        ],
        modelPath: '${process.env.PUBLIC_URL}/src/models/ring_black_and_red.glb',
    ...
    },
    {
        ...
        imageSrc: [
            '${process.env.PUBLIC_URL}/src/img/ring_of_noobs_1.jpg',
            '${process.env.PUBLIC_URL}/src/img/ring_of_noobs_2.jpg',
            '${process.env.PUBLIC_URL}/src/img/ring_of_noobs_3.jpg'
        ],
        modelPath: '',
    ...
    },
    {
        ...
        imageSrc: [
            '${process.env.PUBLIC_URL}/src/img/nenia_ring_1.jpg',
            '${process.env.PUBLIC_URL}/src/img/nenia_ring_2.jpg',
            '${process.env.PUBLIC_URL}/src/img/nenia_ring_3.jpg'
        ],
        modelPath: '',
    ...
    },
    {
        ...
        imageSrc: [
            '${process.env.PUBLIC_URL}/src/img/the_ring_1_carat_1.jpg',
            '${process.env.PUBLIC_URL}/src/img/the_ring_1_carat_2.jpg',
            '${process.env.PUBLIC_URL}/src/img/the_ring_1_carat_3.jpg'
        ],
        modelPath: '',
    ...
    },
    {
        ...
        imageSrc: [
            '${process.env.PUBLIC_URL}/src/img/iron_ring_1.jpg',
            '${process.env.PUBLIC_URL}/src/img/iron_ring_2.jpg',
            '${process.env.PUBLIC_URL}/src/img/iron_ring_3.jpg'
        ],
        modelPath: '',
