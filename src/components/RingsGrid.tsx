...
const ringsRepository = [
    {
        ...
        imageSrc: [
            './ar_ring_try-on/src/img/Ring_black_and_red_1.jpg',
            './ar_ring_try-on/src/img/Ring_black_and_red_2.jpg',
            './ar_ring_try-on/src/img/Ring_black_and_red_3.jpg'
        ],
        modelPath: './ar_ring_try-on/src/models/ring_black_and_red.glb',
    ...
    },
    {
        ...
        imageSrc: [
            './ar_ring_try-on/src/img/ring_of_noobs_1.jpg',
            './ar_ring_try-on/src/img/ring_of_noobs_2.jpg',
            './ar_ring_try-on/src/img/ring_of_noobs_3.jpg'
        ],
        modelPath: '',
    ...
    },
    {
        ...
        imageSrc: [
            './ar_ring_try-on/src/img/nenia_ring_1.jpg',
            './ar_ring_try-on/src/img/nenia_ring_2.jpg',
            './ar_ring_try-on/src/img/nenia_ring_3.jpg'
        ],
        modelPath: '',
    ...
    },
    {
        ...
        imageSrc: [
            './ar_ring_try-on/src/img/the_ring_1_carat_1.jpg',
            './ar_ring_try-on/src/img/the_ring_1_carat_2.jpg',
            './ar_ring_try-on/src/img/the_ring_1_carat_3.jpg'
        ],
        modelPath: '',
    ...
    },
    {
        ...
        imageSrc: [
            './ar_ring_try-on/src/img/iron_ring_1.jpg',
            './ar_ring_try-on/src/img/iron_ring_2.jpg',
            './ar_ring_try-on/src/img/iron_ring_3.jpg'
        ],
        modelPath: '',
